<dialog id="tukar_saldo" class="modal">
    <div class="modal-box relative p-0 bg-white w-[447px] z-[100]">
        ...
        <div class="border-b-2 w-full gap-6">
            <div class="px-6">
                <div class="flex mb-6">
                    <p class="text-[16px] font-semibold">Rekening Kamu</p>

                </div>
                <div class="flex justify-between items-center mb-6">
                    <div class="">
                        <p>Faris Ku</p>
                        <p class="font-semibold text-[16px]">BCA · 53424313141</p>
                    </div>
        ...
        <div class="px-6 py-4">
            <button class="text-[16px] font-semibold p-[8px_40px] btn-primary rounded-xl w-full" onclick="input_nominal.showModal()">Lanjutkan</button>
            @include('components/member/modal-input-nominal')
        </div>
