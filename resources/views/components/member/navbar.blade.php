        ...
        <div class="absolute bottom-0 left-0 flex h-[650px] w-full items-start overflow-auto rounded-t-[30px] bg-white">
            <div class="relative">
                <aside class="fixed h-screen w-[340px] px-[40.32px] py-[47.41px] text-[#0A0A0B]">
                    {{-- start: Side Menu --}}
                    <div
                        class="flex flex-col justify-between gap-[20.32px] rounded-[12.7px] border border-[#E5E5E5] py-[20.32px]">
                        {{-- start: nav item --}}
                ...
                <div id="profil-pengguna" class="w-[100%] px-[44px] py-[47.41px] pl-[380px]">
                    ...
                    <div class="mt-7 flex w-[100%] flex-col items-center justify-center rounded-2xl px-[24px] py-[24px]"
                    ...
                    <div class="mt-8 flex w-[100%] flex-col justify-between gap-8 rounded-2xl px-[24px] py-[24px]"
                        style="box-shadow: 0px 4px 15px 7px rgba(0, 0, 0, 0.15);">
                        ...
                        <div class="flex justify-between">
                            <div class="flex w-[472px] flex-col">
                                ...
                                <input type="text"
                                    class="flex h-[50px] rounded-lg border border-[#969EBA] pl-3 text-[20px]"
                                    value="Farisku">
                            </div>
                            <div class="flex w-[472px] flex-col">
                ...
                <div id="daftar-alamat" class="hidden w-[100%] px-[44px] py-[47.41px] pl-[380px]">
                    ...
                    <div
                        class="mt-7 flex w-[100%] flex-col justify-between gap-6 rounded-2xl border border-[#E5E5E5] px-[24px] py-[24px]">
                        <button
                            class="btn btn-primary w-[312px] rounded-xl px-6 py-4 text-[20px] font-semibold text-white">Tambah
                            Alamat Baru</button>
                        <div
                            class="flex h-[236px] w-[100%] flex-col justify-between rounded-2xl border border-primary bg-[#F2FFF5] px-[24px] py-[24px]">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="mt-3">
                                    <button
                                        class="btn btn-primary w-fit rounded-xl px-6 py-4 text-[12px] font-semibold text-white">Pilih</button>
                                </div>
                            </div>
                        </div>
                        <div
                            class="flex h-[236px] w-[100%] flex-col justify-between rounded-2xl border border-[#E5E5E5] px-[24px] py-[24px]">
                            <div class="flex items-center justify-between">
                                <div class="flex w-[806px] flex-col gap-6">
                                    <p class="text-[16px] font-semibold text-[#0A0A0B]">Alamat Rumah</p>
                                    <div>
                ...
                <div id="ubah-alamat" class="hidden w-[100%] px-[44px] py-[47.41px] pl-[380px]">
                    ...
                    <div
                        class="mt-8 flex w-[100%] flex-col justify-between gap-8 rounded-2xl border border-[#E5E5E5] px-[24px] py-[24px]">
                        ...
                        <div class="flex justify-between">
                            <div class="flex w-[472px] flex-col">
                                ...
                                <select class="flex h-[50px] rounded-lg border border-[#969EBA] pl-3 text-[20px]"
                                    value="Farisku">
                        ...
                        <div class="flex w-[100%] flex-col">
                            ...
                            <textarea type="text" class="h-[130px] rounded-lg border border-[#969EBA] py-2 pl-3 text-[20px]"
                                value="Alamat Saya Disini "></textarea>
                        </div>
                        <div class="flex">
                            <button
                                class="btn btn-error btn-outline mr-6 w-fit text-[20px] font-semibold">Batal</button>
                ...
                <div id="tambah-alamat" class="hidden w-[100%] px-[44px] py-[47.41px] pl-[380px]">
                    ...
                    <div
                        ...
                        <div class="flex w-[100%] flex-col">
                            <label class="text-[20px] font-semibold text-[#0A0A0B]">Alamat Lengkap</label>
                            <textarea type="text" class="h-[130px] rounded-lg border border-[#969EBA] py-2 pl-3 text-[20px]"
                                placeholder="Alamat Saya Disini "></textarea>
                        </div>
                        <div class="flex">
                            <button
                                class="btn btn-error btn-outline mr-6 w-fit text-[20px] font-semibold">Batal</button>
                ...
                <div id="rekening" class="hidden w-[100%] px-[44px] py-[47.41px] pl-[380px]">
                    ...
                    <div
                        class="mt-7 flex w-[100%] flex-col justify-between rounded-2xl border border-[#E5E5E5] px-[24px] py-[24px]">
                        <div
                            class="flex w-[100%] flex-col justify-between rounded-2xl border border-primary bg-[#F2FFF5] px-[24px] py-[24px]">
                                ...
                                <div class="flex h-[208px] w-[806px] flex-col gap-8">
                                    <div class="flex w-[100%] flex-col">
                                        <label class="text-[20px] font-semibold text-[#969EBA]">Pemilik
                                            Rekening</label>
                                        <input type="text"
                                            class="flex h-[50px] rounded-2xl border border-[#969EBA] bg-transparent pl-3 text-[20px]"
                                            value="Farisku">
                                    </div>
                                    <div class="W-[100%] flex justify-between">
                                        <div class="w-[387px]] flex flex-col">
                                            ...
                                            <input type="text"
                                                class="flex h-[50px] w-[387px] rounded-2xl border border-[#969EBA] bg-transparent pl-3 text-[20px]"
                                                value="BNI">
                                        </div>
                            ...
                            <div class="mt-3 flex justify-end">
                                <button
                                    class="btn w-fit rounded-xl px-6 py-4 text-[12px] font-semibold text-[#969EBA]">Ganti
                                    Rekening</button>
                            </div>
                        </div>
