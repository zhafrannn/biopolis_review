    ...
    <div class="modal-box w-11/12 max-w-5xl">
        <div class="px-[20px] overflow-hidden">
            ...
            <form action="{{ route('cms_update') }}" method="POST">
                ...
                <div class="flex flex-col mt-9">
                    <label for="" class="text-[13.54px]">Teks Judul</label>
                    <textarea name="data[{{ $teks_sub_judul_tentang_kami_3->key }}]" type="text" class="border border-[#c8c7c7] rounded-xl h-[98px] px-[24px] pt-2">{{ $teks_sub_judul_tentang_kami_3->value }}</textarea>
                </div>
            </form>
        </div>
    </div>
