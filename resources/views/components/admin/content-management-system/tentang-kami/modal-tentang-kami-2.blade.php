        ...
        <div class="px-[20px] overflow-hidden">
            ...
            <form action="{{ route('cms_update') }}" method="POST">
                ...
                <div class="flex flex-col mt-9">
                    ...
                    <input name="data[{{$gambar_tentang_kami_2->key}}]" type="text" class="border border-[#E5E5E5] rounded-xl h-[57px] px-[24px] " value="{{ $gambar_tentang_kami_2->value }}">
                </div>
                <div class="flex flex-col mt-9">
                    <label for="" class="text-[13.54px]">Teks Judul</label>
                    <input name="data[{{ $teks_judul_tentang_kami_2->value }}]" type="text" class="border border-[#E5E5E5] rounded-xl h-[56px] px-[24px] font-semibold" value="{{ $teks_judul_tentang_kami_2->value }}">
                </div>
                <div class="flex flex-col mt-9">
                    <label for="" class="text-[13.54px]">Teks Judul</label>
