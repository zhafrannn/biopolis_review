<dialog id="edit_tentang_kami_1" class="modal overflow-hidden">
        ...
        <div class="px-[20px] overflow-hidden">
            ...
            <form action="{{ route('cms_update') }}" method="POST">
                ...
                <div class="flex flex-col mt-9">
                    ...
                    <textarea name="data[{{ $teks_sub_judul_tentang_kami_1->key }}]" id="" class="border border-[#E5E5E5] rounded-xl h-[98px] px-[24px] pt-2">{{$teks_sub_judul_tentang_kami_1->value}}</textarea>
                </div>
                <div class="flex flex-col mt-9">
                    <label for="" class="text-[13.54px]">Gambar</label>
                    <input type="text" name="data[{{ $gambar_tentang_kami_1->key }}]" class="border border-[#E5E5E5] rounded-xl h-[56px] px-[24px]" value="{{$gambar_tentang_kami_1->value}}">
                </div>
            </form>
        </div>
    </div>
