<div class="fixed -left-[100%] top-0 z-[999] h-screen w-screen bg-white p-5 transition-all duration-300"
    id="navbar-mobile">
    <div class="flex flex-col">
        ...
        <div class="mt-[60px] flex flex-col p-3 text-[16px]">
            ...
            <div class="mt-[215px]">
                <a href="{{ url('/login') }}"
                    class="mb-[20px] flex w-[100%] justify-center rounded-[10px] border border-primary p-[10px] font-medium">
                    <p>Login</p>
                </a>

                <a href="{{ url('/register') }}"
                    class="flex w-[100%] justify-center rounded-[10px] border border-primary bg-primary p-[10px] font-medium text-white">
                    <p>Register</p>
                </a>
            </div>
            <p class="-right-[0%]"></p>
