        ...
        <div class="w-[633px]">
            ...
            <div class="mb-[50px]">
                <form action="{{ url('/login') }}" method="POST">
                    ...
                    <div>
                        <button type="submit"
                            class="rounded-[15px] bg-primary px-[214px] py-[14px] text-white">Login</button>
                    </div>
                ...
                <form action="">
                    <div class="mb-[70px]">
                        <div class="mb-[30px] flex flex-col">
                            ...
                            <input type="text" class="rounded-[9.904px] border p-[10.56px]" placeholder="Masukan Email">
                        </div>
                        <div class="flex flex-col">
                            <label for="" class="mb-[10px] text-[14px] font-semibold">Password</label>
                            <input type="text" class="rounded-[9.904px] border p-[10.56px]"
                    ...
                    <div class="pt-[60px]">
                        <button
                            class="w-[100%] rounded-[9.904px] bg-primary px-[141.299px] py-[9.244px] text-white">Masuk</button>
                    </div>
