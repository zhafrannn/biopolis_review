...
<section class="grid grid-cols-1 px-5 py-[80px] lg:grid-cols-2 lg:px-[120px]">
    ...
    <div class="fixed -right-[1000px] top-24 z-[999] w-fit transition-all duration-300" id="alert">
        <div class="alert alert-error relative">
            ...
            <button class="flex h-5 w-5 items-center justify-center rounded-full bg-white bg-opacity-50 font-bold" onclick="CloseAlert()">x</button>
        </div>
    </div>
    ...
    <div class="h-full w-full lg:overflow-hidden">
        ...
        <div class="flex h-full pl-0 lg:pl-3">
            ...
            <div class="boder relative hidden h-full w-[1px] bg-[#D9D9D9] lg:block">
                <div class="mb-[1580px] flex h-5 w-5 -translate-x-[9px] items-center justify-center rounded-full bg-[#D9D9D9] bg-opacity-30">
                    <div class="h-3 w-3 rounded-full bg-[#D9D9D9]"></div>
                </div>
                <div class="mb-[550px] flex h-5 w-5 -translate-x-[9px] items-center justify-center rounded-full bg-[#D9D9D9] bg-opacity-30">
                    <div class="h-3 w-3 rounded-full bg-[#D9D9D9]"></div>
                </div>
                <div class="mb-[430px] flex h-5 w-5 -translate-x-[9px] items-center justify-center rounded-full bg-[#D9D9D9] bg-opacity-30">
                    <div class="h-3 w-3 rounded-full bg-[#D9D9D9]"></div>
                </div>
                <div class="flex h-5 w-5 -translate-x-[9px] items-center justify-center rounded-full bg-[#D9D9D9] bg-opacity-30">
                    <div class="h-3 w-3 rounded-full bg-[#D9D9D9]"></div>
                </div>
            </div>
            {{-- End: Line --}}
            ...
            <div class="w-full lg:flex-1 lg:pl-[103px]">
                <form action="{{ url('/register') }}" method="post">
                    ...
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        ...
                        <input type="text" class="rounded-[15px] border p-4" placeholder="Masukan Nama" name="name" required>

                    </div>
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        <label for="" class="mb-[16px] text-[24px] font-semibold">NIK</label>
                        <input type="number" class="rounded-[15px] border p-4" placeholder="Masukan NIK" name="nik" required>
                    </div>
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        <label for="" class="mb-[16px] text-[24px] font-semibold">No Whatsapp</label>
                        <input type="text" class="rounded-[15px] border p-4" name="no_whatsapp" placeholder="Masukan No Whatsapp" required>
                    </div>
                    <div class="mb-[30px] w-full border-b pb-[6px] text-[20px] font-medium text-[#D9D9D9] lg:w-[400px]">
                        <p>Alamat</p>
                    </div>
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        ...
                        <select id="" class="rounded-[15px] border p-4" name="provinsi" required>
                    ...
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        ...
                        <select id="" class="rounded-[15px] border p-4" name="kota" required>
                    ...
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        ...
                        <textarea id="" cols="30" name="alamat_lengkap" rows="10" class="h-[137px] rounded-[15px] border p-4"></textarea>
                    </div>
                    ...
                    <div class="mb-[120px] flex w-full flex-col lg:w-[400px]">
                        ...
                        <input type="password" class="rounded-[15px] border p-4" placeholder="Masukan Konfirmasi Password" name="confirmation_password">
                    </div>
                    ...
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        ...
                        <input type="number" class="rounded-[15px] border p-4" placeholder="Masukan Nomor Rekening" name="no_rekening" required>
                    </div>

                    <div class="mb-[120px] flex w-full flex-col lg:w-[400px]">
                        <label for="" class="mb-[16px] text-[24px] font-semibold">Nama Rekening</label>
                        <input type="text" class="rounded-[15px] border p-4" placeholder="Masukan Nama Rekening" name="nama_rekening" required>
                    </div>
                    ...
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        ...
                        <input type="text" class="rounded-[15px] border p-4" placeholder="Masukan Nama Kontak Darurat" name="nama_kontak_darurat" required>
                    </div>

                    <div class="mb-[120px] flex w-full flex-col lg:w-[400px]">
                        <label for="" class="mb-[16px] text-[24px] font-semibold">Kontak Darurat / Ahli
                            Waris</label>
                        <input type="number" class="rounded-[15px] border p-4" placeholder="Masukan Nomor Kontak Darurat / Ahli Waris" name="nomor_kontak_darurat" required>
                    </div>
                    ...
                    <div class="mb-[30px] flex w-full flex-col lg:w-[400px]">
                        <label for="" class="mb-[16px] text-[24px] font-semibold text-primary">Kode
                            Referal</label>
                        <input type="text" class="rounded-[15px] border border-primary p-4" placeholder="Masukan Kode Referal" name="kode_referal" id="referralCode" required>
                    </div>
