...
@section('content')
    <section
        class="flex w-screen flex-col items-center px-[20px] text-center lg:mb-[75px] lg:flex-row lg:justify-between lg:px-[120px] lg:pt-[98px] lg:text-left"
        ...
        <div class="p-[22px] lg:w-[633px]">
            <h1 class="text-[20px] font-bold lg:mb-[10px] lg:text-[50px] lg:leading-[65px]"><span
                    class="text-primary">Biopolis Propolis</span>
                Kunci Menuju
                Kesehatan yang
                Kuat dan
                Berkelanjutan
        ...
        <div class="flex flex-col items-center">
            <img src="{{ asset('images/img-hero.png') }}" alt="" class="w-[303.836px] lg:w-[359px]">
            <!-- button Mobile -->
            <a href=""
        ...
        <section class="mb-[20px] rounded-[16px] bg-[#D6FFDE] px-[11px] pb-[11px] pt-[20px]">
            ...
            <div class="flex items-center rounded-[16px] bg-primary py-[17px] pl-[15px] pr-[22px] text-white">
                <div class="flex h-[87px] w-[135px] flex-col items-center justify-center border-r-2 border-white">
                    <h2 class="text-[39.334px] font-bold leading-[65px]">4.9</h2>
                    <p class="text-[15.734px] leading-[30px]">10K rating</p>
                </div>
                <div class="flex h-[109px] flex-col items-center justify-center">
                    <div class="pl-[30px] text-center">
                        <h2 class="text-[39.334px] font-bold leading-[65px]">80Jt+</h2>
                        <p class="text-[15.734px] leading-[30px]">Total sale</p>
                    </div>
                </div>
            </div>
        </section>
        <div class="flex items-center justify-between gap-[25px]">
            <img src="{{ asset('images/guarantee.png') }}" alt="" class="w-[88.195px]">
            <img src="{{ asset('images/best-seller.png') }}" alt="" class="w-[88.195px]">
            <img src="{{ asset('images/premium-quality.png') }}" alt="" class="w-[88.195px]">
        </div>
    </div>
    <!-- end mobile -->
    ...
    <section class="mb-[130px] hidden grid-cols-2 lg:grid">
        ...
        <div class="flex flex-col items-center justify-center">
            <div>
                <h1 class="mb-[10px] text-[50px] font-bold leading-[77.77px]">Sehat Dengan <span
                        class="text-primary">Biopolis</span>
                </h1>
    ...
    <section class="mb-[50px] lg:hidden">
        ...
        <div class="flex flex-col items-center justify-center px-[23.5px] text-center">
            <div class="flex flex-col items-center">
                <h1 class="mb-[10px] text-[20px] font-bold leading-[77.77px]">Sehat Dengan <span
                        class="text-primary">Biopolis</span>
                </h1>
                <p class="text-[10px]">Biopolis Propolis adalah Zat Resin yang dihasilkan oleh Lebah
                    dari bahan
                    dasar yang diambil dari pucuk
                    tumbuhan. Zat ini kaya akan kandungan Flavonoid yang sangat baik sebagai antioksidan, sehingga kerap
                    dimanfaatkan untuk mengatasi beberapa masalah kesehatan.”</p>
    ...
    <section class="mb-[241px] hidden h-[313px] flex-col items-center justify-center bg-[#F2FFF5] lg:flex">
        <h1 class="font-bold lg:text-[50px]">Propolis <span class="mb-[15px] text-primary">Premium</span> yang Terjamin</h1>
    ...
    <section class="mb-[50px] flex flex-col items-center justify-center bg-[#F2FFF5] lg:hidden">
        <div class="p-[20px] text-center">
            <h1 class="mb-[9px] px-[38px] text-[20px] font-bold">Propolis <span class="text-primary">Premium</span> yang
                Terjamin</h1>
            <p class="text-[10px]">Produk alami yang menggabungkan kekayaan propolis berkualitas tinggi
                dengan
                penelitian ilmiah terkini, menciptakan kunci menuju kesehatan yang kuat dan berkelanjutan bagi Anda. Anda
                dapat
                mengalami manfaat luar biasa dari propolis, yang telah terbukti meningkatkan daya tahan tubuh, melindungi
                tubuh
                dari infeksi, dan mendukung kesehatan umum.</p>
        </div>
    </section>
    ...
    <section class="mb-[60px] lg:mb-[241px]" id="manfaat-section">
        ...
        <div class="flex flex-col items-center justify-center px-[20px] text-center lg:hidden">
            <h1 class="mb-[15px] text-[20px] font-bold">Manfaat <span class="text-primary">Biopolis</span> untuk Kesehatan
            </h1>
            <p class="text-center text-[10px]">Satu ulasan dari Saudi Journal of Biological Science menunjukkan
                bahwa orang telah menggunakan senyawa ini sebagai obat sejak tahun 300 SM. Bahkan selama Perang Dunia II,
                senyawa ini digunakan untuk membantu penyembuhan luka. Menurut penelitian tersebut, manfaat senyawa ini
                datang dari beberapa sifatnya</p>
        </div>
        ...
        <div class="my-[22px] flex justify-center px-[20px] lg:mb-[50px] lg:px-[121px]">
            <img src="{{ asset('images/manfaat-biopolis.png') }}" alt="" class="">
        </div>
        ...
        <div class="flex flex-col items-center lg:hidden">
            ...
            <div class="mx-[18px] flex flex-col items-center py-[20px] text-center">
                <img src="{{ asset('images/icons/pendapatan-penjualan.svg') }}" class="mb-[14px] w-[67px]"
                    alt="">
                <h2 class="mb-[10px] text-[18px] font-semibold">Pendapatan Dari Penjualan</h2>
                <p class="text-center text-[11px]">Ketika Bergabung Menjadi Mitra Bioplis, anda Akan mendapatkan Harga yang
                    jauh lebih
                    murah dan akan mendapatkan keuntungan yang signifikan ketika menjual langsung kepada End User</p>
            </div>
            {{-- end: Card --}}
            ...
            <div class="mx-[18px] flex flex-col items-center py-[20px] text-center">
                <img src="{{ asset('images/icons/pendapatan-penjualan.svg') }}" class="mb-[14px] w-[67px]"
                    alt="">
                <h2 class="mb-[10px] text-[18px] font-semibold">Pendapatan Dari Penjualan</h2>
                <p class="text-[11px]">Ketika Bergabung Menjadi Mitra Bioplis, anda Akan mendapatkan Harga yang jauh lebih
                    murah dan akan mendapatkan keuntungan yang signifikan ketika menjual langsung kepada End User</p>
            </div>
            {{-- end: Card --}}
            {{-- start: Card --}}
    ...
    <section class="mb-[60px] px-[28px] lg:hidden">
        ...
        <div class="flex flex-col items-center justify-between px-[20px]">
            ...
            <div class="mt-[30px] flex w-[100%] flex-col items-center text-center">
                <h1 class="mb-[10px] text-[20px] font-bold"><span class="text-primary">Propolis</span> Biopolis</h1>
                ...
                <div class="relative max-w-[236px]">
                    ...
                    <p class="text-[19px] font-semibold text-[#969EBA]">Rp 3.000.000</p>
                </div>

                <h3 class="mb-[15px] text-[24px] font-semibold text-[#0A0A0B]">Rp 1.950.000</h3>

                <h3 class="mb-[29px] text-[16px] font-bold">12 Pcs Biopolis + Akun Kemitraan</h3>
                <div class="flex items-center gap-[28px] px-[37px]">
                    <a href=""
                        class="rounded-[9px] border border-primary bg-primary p-[9.714px_14.571px] text-[9.714px] text-white">Order
                        Sekarang</a>

                    <a href=""
                        class="flex items-center justify-center gap-5 rounded-[9px] border border-primary bg-white p-[9.714px_14.571px] text-[9.714px] text-primary">
                        <p>
                            Pelajari Keuntungan
                        </p>
                        <svg width="25" height="26" viewBox="0 0 25 26" fill="none"
    ...
    <section class="mb-[60px] px-[20px] lg:hidden">
        <div
            ...
            <div class="flex flex-col items-center gap-[15px]">
                <svg width="53.305px" height="53.305px" viewBox="0 0 70 70" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.83337 24.792H39.375" stroke="#0A0A0B" stroke-width="4.375" stroke-miterlimit="10"
                        stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M17.5 48.125H23.3333" stroke="#0A0A0B" stroke-width="4.375" stroke-miterlimit="10"
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="h-[159px] w-[238px] rounded-[8px] bg-white p-[17.026px_31.072px_17.026px_17.026px;]">
                            ...
                            <div class="flex gap-1">
                                <svg width="9.79" height="9.79" viewBox="0 0 19 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M8.54894 0.927051C8.8483 0.00574017 10.1517 0.00573993 10.4511 0.927051L11.8574 5.25532C11.9913 5.66734 12.3752 5.9463 12.8085 5.9463H17.3595C18.3282 5.9463 18.731 7.18592 17.9473 7.75532L14.2654 10.4303C13.9149 10.685 13.7683 11.1364 13.9021 11.5484L15.3085 15.8766C15.6078 16.798 14.5533 17.5641 13.7696 16.9947L10.0878 14.3197C9.7373 14.065 9.2627 14.065 8.91221 14.3197L5.23037 16.9947C4.44665 17.5641 3.39217 16.798 3.69153 15.8766L5.09787 11.5484C5.23174 11.1364 5.08508 10.685 4.7346 10.4303L1.05275 7.75532C0.269035 7.18592 0.67181 5.9463 1.64053 5.9463H6.19155C6.62477 5.9463 7.00873 5.66734 7.1426 5.25532L8.54894 0.927051Z"
                                        fill="#FFCC00" />
    ...
    <section class="mb-[60px] lg:hidden">
        ...
        <div class="flex justify-center">
            <div class="flex items-center gap-[10px]">
                ...
                <a href=""
                    class="text rounded-[8px] border border-primary bg-primary p-[9.714px_14.571px] text-[9.714px] text-white">Order
                    Sekarang</a>

                <a href=""
                    class="flex items-center justify-center gap-1 rounded-[8px] border border-primary bg-white p-[9.714px_14.571px] text-[9.714px] text-primary">
                    <svg width="13.6" height="13.6" viewBox="0 0 28 28" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M8.05004 24.033C9.80004 25.083 11.9 25.6663 14 25.6663C20.4167 25.6663 25.6667 20.4163 25.6667 13.9997C25.6667 7.58301 20.4167 2.33301 14 2.33301C7.58337 2.33301 2.33337 7.58301 2.33337 13.9997C2.33337 16.0997 2.91671 18.083 3.85004 19.833L2.84722 23.69C2.62005 24.5638 3.42879 25.3534 4.29686 25.1053L8.05004 24.033Z"
                            stroke="#20B15A" stroke-width="1.75" stroke-miterlimit="10" stroke-linecap="round"
