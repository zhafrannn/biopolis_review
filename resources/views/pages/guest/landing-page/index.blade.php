...
@section('content')
    ...
    <section class="px-[20px] lg:px-[121px]" id="mitra-section">
        ...
        <div class="hidden grid-cols-3 gap-x-[48px] gap-y-[11px] lg:grid">
            ...
            {{-- start: Card --}}
            <div class="px-[20px] py-[40px]">
                <img src="{{ asset('images/icons/pendapatan-sebagai-affiliator.svg') }}" class="mb-[20px]"
                    alt="">
            ...
            {{-- start: Card --}}
            <div class="px-[20px] py-[40px]">
                <img src="{{ asset('images/icons/bonus-uang-dan-poin.svg') }}" class="mb-[20px]" alt="">
            ...
            {{-- start: Card --}}
            <div class="px-[20px] py-[40px]">
                <img src="{{ asset('images/icons/kesempatan-umroh.svg') }}" class="mb-[20px]" alt="">
            ...
            {{-- start: Card --}}
            <div class="px-[20px] py-[40px]">
                <img src="{{ asset('images/icons/komunitas-pengusaha.svg') }}" class="mb-[20px]" alt="">
            ...
            {{-- start: Card --}}
            <div class="px-[20px] py-[40px]">
                <img src="{{ asset('images/icons/hadiah-uang-dan-motor.svg') }}" class="mb-[20px]" alt="">
        ...
        <div class="flex items-center justify-between px-[120px]">
            ...
            <div class="w-[633px]">
                ...
                <div class="relative max-w-[236px]">
                    ...
                    <p class="max-w-[236px] text-[36px] font-semibold text-[#969EBA]">
                        {{ $teks_sub_judul_kemitraan_11_1->value }}
                    </p>
                </div>

                <h3 class="mb-[50px] text-[50px] font-semibold text-[#0A0A0B]">
                    {{ $teks_sub_judul_kemitraan_11_2->value }}
                </h3>
    ...
    <section class="mb-[60px] px-[28px] lg:hidden">
        ...
        <div class="flex flex-col items-center justify-between px-[20px]">
            ...
            <div class="mt-[30px] flex w-[100%] flex-col items-center text-center">
                ...
                <h3 class="mb-[15px] text-[24px] font-semibold text-[#0A0A0B]">
                    {{ $teks_sub_judul_kemitraan_11_2->value }}</h3>
                ...
                <div class="swiper-wrapper">
                    @foreach ($testimonies as $testimony)
                        <div class="swiper-slide">
                            {{-- start: Card --}}
                            <div class="min-h-[300px] w-[450px] rounded-[30px] bg-white p-[40px]">
                                <h3 class="text-[28px] font-semibold">
                                    {{ $testimony->name }}
                                </h3>
                                <p class="mb-[18px] text-[20px] text-[#969EBA]">{{ $testimony->age }} Tahun</p>
                                <?php
                                $stringAwal = $testimony->description;
                                $stringHasil = strlen($stringAwal) > 200 ? substr($stringAwal, 0, 200) . '...' : $stringAwal;
                                ?>
                                <p class="mb-[18px] max-w-[400px] text-[16px] text-black">{{ $stringHasil }}
                                </p>
                                {{-- start: rating star --}}
                ...
                <div class="swiper-wrapper">
                    @foreach ($testimonies as $testimony)
                        <div class="swiper-slide">
                            {{-- start: Card --}}
                            <div
                                class="h-[159px] w-[238px] rounded-[8px] bg-white p-[17.026px_31.072px_17.026px_17.026px;]">
    ...
    <section class="mb-[246px] hidden lg:block">
        ...
        <div class="flex justify-center">
            <div class="flex items-center gap-[28px]">
                ...
                <a href="{{ $link_button_whatsapp->value }}" target="_blank"
                    class="flex items-center justify-center gap-5 rounded-[16px] border border-primary bg-white px-[30px] py-[20px] text-primary">
