                            ...
                            <form action="{{ url('/member/payment') }}" method="post">
                                ...
                                <div class="flex items-start">
                                    <div class="m-3 w-8/12 gap-6 rounded-2xl bg-white p-[24px] shadow-md">
                                        ...
                                        @foreach ($variants as $variant)
                                            <div class="mb-2 flex justify-between gap-2">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="flex">
                                                        {{-- <button class="button-plus btn btn-primary">-</button> --}}

                                                        {{-- ID VARIANT --}}
                                                        <input type="number" name="variant[{{ $index }}][id]"
                                                            value="{{ $variant->id }}"
                                                            class="input input-primary hidden w-20" max="100">
                                                        {{-- NILAI VARIAN --}}
                                                        <input type="number" name="variant[{{ $index }}][value]"
                                                            class="input input-primary w-20" value="0" min="0"
                                                            max="100">

                                                        {{-- <button class="button-minus btn btn-primary">+</button> --}}
                                                    </div>
                                        ...
                                        {{-- product id --}}
                                        <input type="text" name="product_id" value="{{ $item->id }}" id="">
                                        {{--  --}}
                                        ...
                                        <div class="mt-6 flex items-start justify-between">
                                            ...
                                            <div class="flex flex-col items-end justify-between">
                                                ...
                                                <div class="flex gap-6">
                                                    ...
                                                    <style>
                                                        #ambil_ditempat{{ $item->id }}:checked+label {
                                                            background-color: #20b15a !important;
                                                            color: white !important;

                                                        }

                                                        #dikirim{{ $item->id }}:checked+label {
                                                            background-color: #20b15a !important;
                                                            color: white !important;
                                                        }
                                                    </style>
                                                    ...
                                                    <div class="space-y-4" id="">
                                                        <input type="radio" id="ambil_ditempat{{ $item->id }}"
                                                            name="shipping_type" value="on_location" class="hidden">
                                                        <label for="ambil_ditempat{{ $item->id }}"
                                                            class="btn cursor-pointer rounded-md px-4 py-2">
                                                            Ambil ditempat
                                                        </label>

                                                        <input type="radio" id="dikirim{{ $item->id }}"
                                                            name="shipping_type" value="on_send" class="hidden">
                                                        <label for="dikirim{{ $item->id }}"
                                                            class="btn cursor-pointer rounded-md">
                                                            Dikirim
                                                        </label>
                                                    </div>
