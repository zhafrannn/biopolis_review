    ...
    <div class="z-10 hidden h-full justify-around p-5 lg:flex">
        ...
        @foreach ($product as $item)
            @if ($item->product_code != 'P00')
                <div class="card-compact card h-[490px] w-[254px] overflow-hidden bg-base-100 shadow-md">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions mt-4 items-center justify-center">
                            <button onclick="HandleTab('tab-{{ $item->product_code }}')"
                                class="text btn btn-primary w-[100%]">Beli
                                Sekarang
                            </button>
                        </div>
                    </div>
                ...
                <div id="tab-{{ $item->product_code }}"
                    class="tab-product fixed -bottom-[1000px] left-0 z-[999] h-screen w-screen bg-black bg-opacity-30 pt-[100px] transition-all duration-300">
                        ...
                        <div class="h-full overflow-y-auto">
                            ...
                            <div class="flex items-start">
                                    ...
                                    <div class="mt-6 flex items-start justify-between">
                                        <div class="flex">
                                            <img src="" alt="gambar-produk"
                                                class="h-[121px] w-[121px] rounded-[5px] bg-[#D9D9D9]">
                                            <div class="ml-4 flex flex-col justify-around">
                                                <p class="text-[20px] font-semibold text-[#0A0A0B]">Paket Biopolis</p>
                                                <div>
                                                    <span
                                                        class="text-[16px] text-[#969EBA] line-through">Rp4.000.0000</span>
                                                    <span
                                                        class="text-[16px] text-[#20B15A]">Rp{{ number_format($item->price) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex flex-col items-end justify-between">
                                            ...
                                            <div class="flex gap-6">
                                                ...
                                                <button onclick="HandleOnLocation('on_location')"
                                ...
                                <div class="m-3 w-4/12 rounded-2xl bg-white p-[20.32px] shadow-md">
                                    ...
                                    <button class="btn btn-primary mt-6 w-[100%]"
                                        onclick="HandlePayment({{ $item->id }})">Konfirmasi
                                        Pembayaran</button>
                                </div>
                            </div>
                        </div>
            ...
            @foreach ($product as $item)
                @if ($item->product_code != 'P00')
                    <div class="m-3 h-[310px] w-[150px] rounded-xl bg-base-100 shadow-md">
                        <figure>
                            <img class="h-[150px] w-[150px] rounded-[12px_12px_0px_0px] bg-[#D9D9D9]"
                                src="/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" alt="Shoes" />
                        </figure>
                        <div class="p-2">
                            ...
                            <div class="card-actions mt-4 items-center justify-center">
                                <button onclick="HandleMobileTab('tab-mobile-{{ $item->product_code }}')"
                                    class="w-full rounded-lg bg-primary p-2 text-[12px] text-white" type="button">
                                    Beli Sekarang
                            </div>
                        </div>
                    </div>

                    <div id="tab-mobile-{{ $item->product_code }}"
                        class="tab-product-mobile fixed -bottom-[1000px] left-0 z-[900] h-full w-screen bg-black bg-opacity-30 transition-all duration-300">
                            ...
                            <div class="h-full w-screen overflow-y-auto">
                                ...
                                <div class="flex flex-col justify-start p-3">
                                    <div class="mb w-full rounded-2xl border bg-white p-[12px] leading-[20px]">
                                        ...
                                        <div class="mt-6">
                                            <div class="flex">
                                                <img src="{{ asset('images/biopolis.png') }}"
                                                    class="h-[50px] w-[50px] rounded-[5px] bg-[#D9D9D9]">
                                                <div class="ml-4 flex flex-col justify-around">
                                                    <p class="text-[14px] font-semibold text-[#0A0A0B]">Paket Biopolis</p>
                                                    <div>
                                                        <span
                                                            class="text-[13px] text-[#969EBA] line-through">Rp4.000.0000</span>
                                                        <span
                                                            class="text-[13px] text-[#20B15A]">Rp{{ number_format($item->price) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-5">
                                                ...
                                                <div class="flex gap-6">
                                                    <button onclick="HandleOnSend('on_send')"
                                                        class="user-send btn btn-primary text-[12px]">
                                                        Dikirim
                                                    </button>
                                                    <button onclick="HandleOnLocation('on_location')"
                                                        class="user-location btn btn-primary btn-outline text-[12px]">
                                                        Ambil ditempat
                                                    </button>
                                                </div>
                                            </div>
