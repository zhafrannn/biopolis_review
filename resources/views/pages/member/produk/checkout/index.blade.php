                    ...
                    <div class="mt-6 flex items-start justify-between">
                        ...
                        <div class="flex flex-col items-end justify-between">
                            ...
                            <div class="flex gap-6">
                                <button
                                    class="btn gap-2 rounded-xl border-[20B15A] bg-[#D6FFDE] p-[8px_24px] text-primary">Dikirim</button>
                                <button
                                    class="btn gap-2 rounded-xl border-[969EBA] bg-white p-[8px_24px] text-[#969EBA]">Dikirim</button>
