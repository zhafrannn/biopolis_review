...
@section('content')
    <section class="mb-[27.92px] hidden text-[#0A0A0B] lg:block">
        ...
        <div class="mb-[28px]">
            <h3 class="text-[20.32px] font-semibold">Daftar Transaksi asd</h3>
        </div>
            ...
            <div class="flex flex-col gap-5">
                @foreach ($user_payment as $item)
                    <a href="{{ $item->redirect_url }}" target="_blank">
                        {{-- start: Card --}}
                        <div class="rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
                            <div class="mb-[13.54px] flex items-start justify-between">
                                <div class="flex items-center gap-[3.39px]">
                                    <img src="{{ asset('images/icons/profile.svg') }}" alt="">
                                    <div class="">
                                        <p class="text-[13px] font-semibold">{{ Auth::user()->name }}</p>
                                        <p class="text-[13px]">21 Okt 2023</p>
                                    </div>
                                </div>
