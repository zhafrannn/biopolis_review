    ...
    <div id="tab-all">
        ...
        <div class="mb-[20px] rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
            <div class="mb-[20.86px] flex flex-col gap-[13.54px] lg:flex-row lg:items-center">
                ...
                <div>
                    <p class="text-[13.54px] items-center font-semibold">No Resi : </p>
            ...
            <div class="lg:flex items-center justify-between">
                ...
                <div class="lg:pl-[13.54px] mt-4 lg:mt-0">
                    <p class="lg:flex justify-end lg:text-[16px] text-[14px]">Total Belanja</p>
                    <h3 class="lg:flex justify-end lg:text-[16px] text-[14px] font-semibold">
            ...
            <div class="flex justify-end">
                <button class="text-[12px] font-semibold text-primary" onclick="modal_transaction_{{ $item->id }}.showModal()">
                ...
                <dialog id="modal_transaction_{{ $item->id }}" class="modal">
                    <div class="modal-box bg-[#E5E5E5] p-0">
                        ...
                        <div class="mb-5 bg-white p-5">
                            <div class="mb-5">
                                <h3 class="lg:text-2xl font-semibold">Detail Transaksi</h3>
                            </div>

                            <div class="mb-5">
                                <h4 class="lg:text-[20px] font-semibold">Sedang dikemas</h4>
                            </div>

                            <div>
                                <div class="flex items-center justify-between lg:text-[16px] text-[14px]">
                        ...
                        <div class="mb-5 bg-white p-5">
                            ...
                            <div class="lg:flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h5 class="lg:text-[20px] text-[14px] font-semibold text-[#0A0A0B]">Paket Biopolis</h5>
                                        <p>1 x Rp{{ number_format($item->product->price) }}</p>
                                    </div>
                                </div>
                                <div class="lg:text-right lg:text-[20px] text-[14px] mt-3 lg:mt-0">
                        ...
                        <div class="bg-white p-5">
                            ...
                            <div>
                                <table class="w-full lg:text-[20px] text-[14px]">
                                    <tr>
                                        <td>Kurir</td>
                                        <td>: JNE Reguler </td>
                                    </tr>
