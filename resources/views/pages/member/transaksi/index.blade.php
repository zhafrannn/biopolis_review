        ...
        <div class="mb-[28px] flex flex-col items-center justify-between gap-2 lg:flex-row">
            <div class="flex flex-col items-center lg:flex-row">
                ...
                <div class="flex items-center gap-2 lg:gap-[13px]">
                    ...
                    <button id="button-tab-packing" onclick="HandleTab('tab-packing')"
                        class="rounded-xl border border-[#969EBA] px-[20.32px] py-[6.77px] text-[13.54px] text-[#969EBA]">Dikemas</button>
                    <button id="button-tab-completed" onclick="HandleTab('tab-completed')"
                        class="rounded-xl border border-[#969EBA] px-[20.32px] py-[6.77px] text-[13.54px] text-[#969EBA]">Sudah
                        Dikirim</button>
                </div>
            </div>
            <div>
                        ...
                        <dialog id="modal_transaction_{{ $item->id }}" class="modal">
                            <div class="modal-box bg-[#E5E5E5] p-0">
                                ...
                                <div class="mb-5 bg-white p-5">
                                    <div class="mb-5">
                                        <h3 class="text-2xl font-semibold">Detail Transaksi</h3>
                                    </div>

                                    <div class="mb-5">
                                        <h4 class="text-[20px] font-semibold">Sedang dikemas</h4>
                                    </div>
                                ...
                                <div class="mb-5 bg-white p-5">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <h5 class="text-[20px] font-semibold text-[#0A0A0B]">Paket Biopolis</h5>
