...
<section class="mb-[27.92px] text-[#0A0A0B]">
    ...
    <div class="mb-[28px] flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div class="flex items-center gap-[13px]">
                ...
                <button class="rounded-xl border border-[#969EBA] px-[20.32px] py-[6.77px] text-[13.54px] text-[#969EBA]">Sedang
                    Dikirim</button>
    ...
    <div class="mb-[20px] rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
        ...
        <div class="flex justify-between items-center">
            <div class="flex gap-[13.54px] items-center">
            ...
            <div class="pl-[13.54px]">
                <p class="text-[16px] flex justify-end">Total Belanja</p>
                <h3 class="text-[16px] flex justify-end font-semibold">Rp2.000.000</h3>
