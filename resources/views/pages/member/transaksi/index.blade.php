            ...
            <div class="items-center justify-between lg:flex">
                <div class="flex items-center gap-[13.54px]">
                    <div class="h-[102px] w-[102px] bg-[#D9D9D9]">
                        <figure class="">
                            <img class="bg-[#D9D9D9] object-cover" src="{{ asset('/images/'. $item->product->image) }}" alt="biopolis-propolis" />
                        </figure>
                    </div>
                    <div>
                        <h3 class="text-[16px] font-semibold">{{ $item->product->product_name }}</h3>
    ...
    <div class="">
        ...
        <div class="mb-[20px] rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
            ...
            <div class="items-center justify-between lg:flex">
                <div class="flex items-center gap-[13.54px]">
                    <div class="h-[102px] w-[102px] bg-[#D9D9D9]">
                        <img src="{{ asset('images/'. $item->product->image) }}" class="h-full w-full object-cover" alt="">
                    </div>
                    <div>
                        <h3 class="text-[16px] font-semibold">{{ $item->product->product_name }}</h3>
                        <p class="text-[13.54px]">{{ number_format($item->product->price) }}</p>
