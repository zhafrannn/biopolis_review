                        ...
                        <div class="mt-4 flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-[24px] font-semibold text-primary" id="total-packet-season">
                                    Rp{{ number_format($data['user_total_buy_payment']) }},-
                                </p>
                            </div>
                ...
                <div class="w-full">
                    <div class="flex w-[100%] gap-2">
                        <div class="w-[100%] rounded-xl border border-[#E5E5E5] p-[0px_8px_8px_8px]">
                            ...
                            <a href="{{ url('/member/point') }}"
                                class="mt-3 flex items-end justify-end text-[11px] text-primary">
                                Lihat Detail
                            </a>
                        </div>
                        <div class="relative w-[100%] rounded-xl border border-[#E5E5E5] p-[0px_8px_8px_8px]">
                            ...
                            <a href="{{ url('/member/info-produk') }}"
                                class="mt-[54px] flex items-end justify-end text-[11px] text-primary">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
