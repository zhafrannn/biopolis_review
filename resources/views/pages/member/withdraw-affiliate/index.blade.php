...
@section('content')
    <section class="mb-[27.92px] hidden lg:block">
        <h2 class="mb-[19.95px] text-[27.09px] font-semibold">Laporan Saldo asd</h2>
        <div class="rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
                ...
                <div class="w-5/12">
                    ...
                    <div class="flex w-[100%] gap-5">
                        <div class="grid-flow">
                            ...
                            <h3 class="text-[33px]">Rp{{ number_format($data['my_balance_from_user_repeat_order']) }},-</h3>
                        </div>
                        <div class="">
                            <h4 class="mb-[10px] text-[20.32px] text-[#969EBA]">User Register</h4>
                            <h3 class="text-[33px]">
            ...
            <div class="w-[100%]">
                <button onclick="modal_exchange_balance.showModal()"
                    class="btn h-16 w-[100%] bg-primary text-[20px] font-semibold text-white">Tukar Saldo</button>
                    ...
                    <tbody>
                        @foreach ($data['income_data'] as $item)
                            <tr class="border-b border-[#969EBA]">
                                ...
                                <td class="p-[10px]">
                                    <div class="min-w-[50px] rounded-md bg-primary px-[4px] text-center text-white">
                    ...
                    <tbody>
                        ...
                        @foreach ($user_balance as $item)
                            <tr class="border-b border-[#969EBA]">
                                ...
                                <td class="p-[10px]">Rp{{ number_format($item->withdraw_total_balance) }},-</td>
