                        ...
                        <div class="border-l-2 pl-[15px]">
                            <div>
                                ...
                                <p class="text-[15px]">Bank <span
                                        class="font-semibold uppercase">{{ $item->user->user_biodata->nama_bank }}</span>
                                </p>
                    ...
                    @if ($item->status == 'pending')
                        ...
                        <div class="flex justify-end gap-5">
                            ...
                            <button class="btn btn-primary"
                                onclick="modal_confirmation_all_{{ $item->id }}.showModal()">Konfirmasi
                                Pencairan</button>
                            <dialog id="modal_confirmation_all_{{ $item->id }}" class="modal">
                                <div class="modal-box">
                                    ...
                                    <div>
                                        <form action="{{ url('/admin/pengajuan-penukaran-poin') }}" method="post"
                                            ...
                                            <div>
                                                ...
                                                <p class="text-[15px]">No Rekening :
                                                    {{ $item->user->user_biodata->no_rekening }}</p>
                                                <p class="text-[15px]">No Whatsapp :
                                                    {{ $item->user->user_biodata->no_whatsapp }}</p>
                                                <input type="number" class="hidden" name="user_withdraw_point_id"
                                                    value="{{ $item->id }}">
            ...
            @foreach ($user_point_exchange as $item)
                @if ($item->status == 'pending')
                    ...
                    <div class="mb-[20px] rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
                        ...
                        <div class="flex justify-end">
                            <button class="btn btn-primary"
                                onclick="modal_confirmation_pending_{{ $item->id }}.showModal()">Konfirmasi
                                Pencairan</button>
            ...
            @foreach ($user_point_exchange as $item)
                @if ($item->status == 'completed')
                    ...
                    <div class="mb-[20px] rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
                        ...
                        <div class="flex justify-end">
                            <button class="btn btn-primary"
                                onclick="modal_confirmation_paid_{{ $item->id }}.showModal()">Konfirmasi
                                Pencairan</button>
