...
@section('content')
    <section class="mb-[27.92px] text-[#0A0A0B]">
        ...
        <div class="mb-[28px]">
            <h3 class="text-[20.32px] font-semibold">Pengajuan Pencairan Komisi</h3>
        </div>
                    ...
                    <div class="grid grid-cols-2">
                        <div class="flex gap-[13.54px]">
                            ...
                            <div>
                                ...
                                <p class="text-[20px] font-semibold">Rp
                                    {{ number_format($withdraw->withdraw_total_balance) }}</p>
                            </div>
                        </div>
                        <div class="border-l-2 pl-[13.54px]">
                            ...
                            <div>
                                ...
                                <p class="text-[15px]">Bank <span
                                        class="font-semibold uppercase">{{ $withdraw->user->user_biodata->nama_bank }}</span>
                                </p>
                        ...
                        <div class="flex justify-end gap-5">
                            ...
                            <div class="flex justify-end">
                                <button class="btn btn-primary"
                                    onclick="my_modal_all_{{ $withdraw->id }}.showModal()">Konfirmasi Pencairan</button>
                            </div>
                            {{-- Modal --}}
                                    ...
                                    <form action="{{ url('/admin/pengajuan-pencairan') }}" method="post">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[15px]">No Rekening :
                                                {{ $withdraw->user->user_biodata->no_rekening }}</p>
                                            <p class="text-[15px]">No Whatsapp :
                                                {{ $withdraw->user->user_biodata->no_whatsapp }}</p>
                                            <input type="text" class="hidden" name="user_withdraw_balance_id"
                                                value="{{ $withdraw->id }}">
                                            <div class="flex justify-end">
                            ...
                            <div class="flex justify-end">
                                <button class="btn btn-error"
                                    onclick="my_modal_all_cancel_{{ $withdraw->id }}.showModal()">Batalkan</button>
                            </div>
                            {{-- Modal --}}
                ...
                <div class="mb-[20px] rounded-xl bg-white p-[20.32px] shadow-[0_3.3px_12px_rgba(0,0,0,0.15)]">
                    ...
                    <div class="flex justify-end">
                        <button
                            ...
                            onclick="my_modal_{{ $withdraw->id }}.showModal()">Konfirmasi Pencairan</button>
                    </div>
                    {{-- Modal --}}
